  ...
  return  courses ? (
    ...
    md:pb-0 p-4 pt-8 pb-0'>
      <div className='w-full'>
        ...
        <div className='flex flex-col items-center max-4-4xl w-full overflow-hidden
        rounded-md bg-white border border-gray-500/20'>
          <table className='md:table-auto table table-fixed w-full overflow-hidden'>
            <thead className='text-gray-900 border border-b border-gray-500/20 text-sm
            text-left'>
              <tr>
              ...
              {courses.map((course) => (
                <tr key={course._id} className='border-b border-gray-500/20'>
                  ...
                  <td className='px-4 py-3'>{currency} {Math.floor(course.
                    enrolledStudents.lenght * (course.coursePrice - course.discount * 
