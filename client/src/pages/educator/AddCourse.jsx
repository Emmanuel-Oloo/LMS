...
// initiate Quill only once
  ...
  return (
    ...
    justify-between p-4 md:p-8 pb-0 pt-8">
      <form className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div ref={editorRef} className="border rounded p-2 min-h-[150px]"></div>
        </div>
        ...
        <div className="flex items-center justify-between flex-wrap">
          ...
          <label htmlFor="thumbnailImage" className="flex items-center gap-3">
            <img src={assets.file_upload_icon} alt="Upload" className="p-3 bg-blue-500
             rounded" />
                    ...
                    items-center mb-2'>
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.
                        ...
                        <img src={assets.cross_icon} alt="" onClick={()=>handleLecture
                          ('remove',chapter.chapterId)} className='cursor-pointer' />
                    </div>
                  ))}
           ...
           bg-gray-800 bg-opacity-50">
            <div className="bg-white text-gray-700 p-4 rounded relative w-full
             max-w-80">
              ...
              <input
                type="text"
                className="block w-full border rounded py-1 px-2 mt-1"
